  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <p className="text-gray-600 mb-8">Use the tools below. Each generates 5 items by default. Click Load More to add 5 more (up to 20). Results are shown as bullet points (no stars).</p>
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {/* Interview and Jobs Sections */}
          {sections.filter(s => s.key !== 'quiz').map((sec) => (
                ...
                {sec.state.items.length > 0 && (
                  <>
                    ...
                    {canLoadMore(sec.state) && (
                      <button
                        onClick={() =>
                          sec.setState((s) => ({ ...s, shown: Math.min(20, s.shown + 5) }))
                        }
