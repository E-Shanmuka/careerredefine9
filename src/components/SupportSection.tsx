      ...
      <div className="relative text-white text-center py-20 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-lg md:text-xl max-w-3xl mx-auto animate-fadeInUp">
            Whether you need an instant answer from our AI or personalized guidance from a seasoned expert, your career success is our top priority.
          </p>
        </div>
      </div>
      ...
      <div className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">Your Success, Our Commitment</h2>
            <p className="mt-4 text-lg text-gray-600">Choose the support that fits your needs.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900">24/7 AI Assistant</h3>
              <p className="mt-4 text-gray-600">
                Get instant, intelligent answers to your career questions anytime, anywhere. Our AI is trained to help with resumes, interview prep, and more.
              </p>
              <a href="#chat" className="mt-6 inline-block bg-indigo-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-indigo-700 transition-colors">
                Chat Now
              </a>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
              ...
              <a href="#community" className="mt-6 inline-block bg-purple-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-purple-700 transition-colors">
                Join Community
              </a>
            </div>
          </div>
